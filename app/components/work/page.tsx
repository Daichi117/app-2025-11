    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <section className="max-w-4xl mx-auto text-center mb-12">
        ...
        <p className="text-muted-foreground mb-8">
          Explore our collection of articles. Each post includes an AI-generated summary 
          to help you quickly find what interests you.
        </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredPosts.map(post => (
              <Link key={post.id} href={`/work/${post.id}`}>
                <article className="bg-card rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-all cursor-pointer group">
                  ...
                  <div className="p-5">
                    ...
                    <p className="text-muted-foreground text-sm mt-2">By {post.author}</p>
                  </div>
                </article>
              </Link>
            ))}
